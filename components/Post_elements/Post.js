        ...
        <View style = {styles.container}>
            ...
            <View style = {styles.av} >
                <SkeletonContent isLoading = {loading}  containerStyle = {{height : 50 , width : 50 , borderRadius : 25}} layout = {[
                    ...
                    <Avatar key = {'pic'} rounded source = {require('../../images/test.jpg')} size = {'medium'}/>
                </SkeletonContent>
            </View>
            ...
            <Card containerStyle = {{borderTopRightRadius : 35}}>
                ...
                <Card.Image style = {{height : 300 , width : 300 , top :30 , margin : 'auto'}} source = {require('../../images/test.jpg')}>
                    </Card.Image> 
                ...
                <View style = {{ width : 250,height : 40,top : 10 }}>
                    <TouchableOpacity style = {styles.review}>
                        <Avatar rounded size = {'small'} source = {require('../././../images/test.jpg')} />
                        <Avatar  rounded size = {'small'} source = {require('../././../images/test.jpg')}/>
                        <Avatar rounded size = {'small'} source = {require('../././../images/test.jpg')} />
                        <Avatar rounded size = {'small'} source = {require('../././../images/test.jpg')} />
